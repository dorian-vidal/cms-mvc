...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="<?= URL ?>/src/Views/css/style_nav_mobile.css">
        <link rel="stylesheet" href="<?= URL ?>/src/Views/css/style_bouton.css">
        <link rel="stylesheet" href="<?= URL ?>/src/Views/css/style.css">
        <link rel="stylesheet" href="<?= URL ?>/src/Views/css/style_admin.css">
    </head>
    ...
    <body>
        <div class="container">
            ...
            <div class="nav_mobile_davy">
                <div class="nav_mobile_center_davy">
                    <a href="<?= URL ?>" class="menu_mobile_davy lien_accueil" title="Accueil">
                        ...
                        <br>
                        <p class="texte_menu_mobile_davy lien_accueil">Accueil</p>
                    </a>
                    <a href="<?= URL ?>/gestion" class="menu_mobile_davy lien_gestion" title="Membre">
                        <svg class="icon_menu_mobile_davy" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-prefix="fas" data-icon="copy"><path fill="currentColor" d="M320 448v40c0 13.255-10.745 24-24 24H24c-13.255 0-24-10.745-24-24V120c0-13.255 10.745-24 24-24h72v296c0 30.879 25.121 56 56 56h168zm0-344V0H152c-13.255 0-24 10.745-24 24v368c0 13.255 10.745 24 24 24h272c13.255 0 24-10.745 24-24V128H344c-13.2 0-24-10.8-24-24zm120.971-31.029L375.029 7.029A24 24 0 0 0 358.059 0H352v96h96v-6.059a24 24 0 0 0-7.029-16.97z"></path></svg>
                        <br>
                        <p class="texte_menu_mobile_davy lien_gestion">Membre</p>
                    </a>
            ...
            <div class="nav_mobile_burger_davy">
                <div class="m-5">
                    <a href="<?= URL ?>" title="Accueil" class="d-inline-block width_full_davy">Accueil</a>
                    <hr class="hr_admin_davy">
                    <a href="<?= URL ?>/gestion" title="Membre" class="d-inline-block width_full_davy">Membre</a>
                    <hr class="hr_admin_davy">
                    <form method="post" id="bouton_deconnecter_davy">
                        <!-- bouton_anim_davy -->
                        <a aria-label="Quitter" class="bouton_anim_davy bouton_envoyer width_full_davy bouton_full_davy" data-text="Déconnecter" title="Déconnecter">
        ...
        <script src="<?= URL ?>/src/Views/js/script_nav_mobile_burger.js"></script>
    </body>
</html>